...
/**
 * Returns the brand name for Social Sharing Link.
 *
 * @param string $service The service icon.
 *
...
function block_outermost_social_sharing_link_services( $service = '', $field = '' ) {
	...
	$services_data = array(
		...
		'whatsapp'   => array(
			...
			'url'   => 'https://api.whatsapp.com/send?text=' . get_the_title() . '%20' . get_the_permalink() . '',
...
// https://api.whatsapp.com/send?text=Creating%20Speech%20Balloons%20With%20the%20WordPress%20Block%20Editor%20https%3A%2F%2Fwptavern.com%2Fcreating-speech-balloons-with-the-wordpress-block-editor
