 ...
 * @param Array  $services An array of all services.
 *
...
/**
 * Returns the service label for the Social Sharing Link.
 *
 * @param String $service  The service.
 * @param Array  $services An array of all services.
 *
...
/**
 * Returns the service url for the Social Sharing Link.
 *
 * @param String $service  The service.
 * @param Array  $services An array of all services.
 *
 ...
 *
 * @param Boolean  $share_custom_link Should a custom link be shared.
...
function get_link_services( $share_custom_link, $block ) {
	...
	// Only enable custom link sharing if a custom link exists.
	if ( $share_custom_link && $custom_link ) {
	...
	$title_title      = $title ? '&title=' . $title : '';
	$text_title       = $title ? '&text=' . $title : '';
	$decription_title = $title ? '&description=' . $title : '';
	$title_separator  = $title ? $title . $separator : '';

	$services_data = array(
		'facebook'  => array(
			'label' => __( 'Share on Facebook', 'social-sharing-block' ),
			'url'   => 'https://www.facebook.com/sharer/sharer.php?u=' . $permalink . $title_title,
			'icon'  => '<svg width="24" height="24" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><path d="M12 2C6.5 2 2 6.5 2 12c0 5 3.7 9.1 8.4 9.9v-7H7.9V12h2.5V9.8c0-2.5 1.5-3.9 3.8-3.9 1.1 0 2.2.2 2.2.2v2.5h-1.3c-1.2 0-1.6.8-1.6 1.6V12h2.8l-.4 2.9h-2.3v7C18.3 21.1 22 17 22 12c0-5.5-4.5-10-10-10z"></path></svg>',
		),
		'flipboard' => array(
			'label' => __( 'Share on Flipboard', 'social-sharing-block' ),
			'url'   => 'https://share.flipboard.com/bookmarklet/popout?url=' . $permalink . $title_title,
		...
		'line'      => array(
			...
			'url'   => 'https://lineit.line.me/share/ui?url=' . $permalink . $text_title,
		...
		'linkedin'  => array(
			...
			'url'   => 'https://www.linkedin.com/shareArticle?mini=true&url=' . $permalink . $title_title,
		...
		'mail'      => array(
			...
			'url'   => 'mailto:?subject=' . ( $title ? $title : $permalink ) . '&body=' . $title_separator . $permalink,
		...
		'pinterest' => array(
			...
			'url'   => 'https://pinterest.com/pin/create/button/?&url=' . $permalink . $decription_title . ( $image ? '&media=' . $image : '' ),
		...
		'pocket'    => array(
			...
			'url'   => 'https://getpocket.com/save/?url=' . $permalink . $title_title,
		...
		'reddit'    => array(
			...
			'url'   => 'https://www.reddit.com/submit?url=' . $permalink . $title_title,
		...
		'sms'       => array(
			...
			'url'   => 'sms:?&body=' . $title_separator . $permalink,
		...
		'telegram'  => array(
			...
			'url'   => 'https://telegram.me/share/url?url=' . $permalink . $text_title,
		...
		'tumblr'    => array(
			...
			'url'   => 'http://tumblr.com/widgets/share/tool?canonicalUrl=' . $permalink . $title_title,
		...
		'twitter'   => array(
			...
			'url'   => 'https://twitter.com/share?url=' . $permalink . $text_title,
